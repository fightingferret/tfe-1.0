...
{
  return (float) 20+(shdata->level-1)*(clss_table[ pcdata->clss ].hit_min
...
{
  return (float) 50+(shdata->level-1)*(clss_table[ pcdata->clss ].mana_min
...
{
  return (float) 100+(shdata->level-1)*(clss_table[ pcdata->clss ].move_min
