...
#define max_relig   MAX_ENTRY_RELIGION
  ...
  if( pc != NULL ) {
    class type_field type_list[] = {
      ...
      { "religion",  max_relig,   (const char **) &rn(0),   (const char **) &rn(1),   &pcdata->religion  },
      { "",          0,           NULL,     NULL,     NULL               },
      };
...
#undef sxn
    ...
    class int_field int_list[] = {
      ...
      { "mod_move",    -5000,      5000,  &pc->mod_move                },
      { "mod_hits",    -5000,      5000,  &pc->mod_hit                 },
      { "mod_mana",    -5000,      5000,  &pc->mod_mana                },
      { "",                0,         0,  NULL                              },
      };
